...
const PatreonIcon = (props: PatreonIconProps) => <svg width={props.width} height={props.height} style={props.style} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
