...
<Image alt="Graph" width={373} height={147} src="/images/skip.svg" />
...
<Image alt="Graph" width={373} height={147} src="/images/take.svg" />
...
<Image alt="Graph" width={399} height={147} src="/images/cursor.svg" />
...
<PrevNext>
  <PrevArticle href="/concepts/components/teo-query-client/filtering-and-sorting">Filtering and sorting</PrevArticle>
  <NextArticle href="/concepts/components/teo-query-client/selecting-fields">Selecting fields</NextArticle>
</PrevNext>
