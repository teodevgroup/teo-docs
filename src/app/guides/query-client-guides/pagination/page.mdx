...
<PrevNext>
  <PrevArticle href="/docs/concepts/components/teo-query-client/filtering-and-sorting">Filtering and sorting</PrevArticle>
  <NextArticle href="/docs/concepts/components/teo-query-client/selecting-fields">Selecting fields</NextArticle>
</PrevNext>
