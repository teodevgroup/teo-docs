...
The next topic introduces filtering and sorting, which is crutial for querying.

<PrevNext>
  <div></div>
  <NextArticle href="/concepts/components/teo-query-client/filtering-and-sorting">Filtering and sorting</NextArticle>
</PrevNext>
