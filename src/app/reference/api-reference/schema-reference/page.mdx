...
Defines a database [connector](/concepts/components/teo-server/connector)
<span className="concept">CONCEPT</span> in the 
[namespace](/concepts/components/teo-server/namespace)
...
[fields](/concepts/components/teo-server/field) <span className="concept">CONCEPT</span>,
[relations](/concepts/components/teo-server/relation) <span className="concept">CONCEPT</span>, and
[properties](/concepts/components/teo-server/property) <span className="concept">CONCEPT</span> in nature.
