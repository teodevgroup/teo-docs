...
<span className="concept">CONCEPT</span> in the Teo schema. This config block is
optional.
...
Defines a [virtual model](/concepts/components/teo-schema/model#virtual-model)
<span className="concept">CONCEPT</span>.
...
Defines an [identity model](/concepts/components/teo-schema/model#identity-model)
<span className="concept">CONCEPT</span>.
...
<span className="concept">CONCEPT</span> are content of models.
