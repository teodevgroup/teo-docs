...
declare pipeline item validateAuthCode: String -> String
...
model User {
  ...
  phoneNumber: String?
  @virtual @writeonly @identity.checker($get(.value).presents.validateAuthCode)
  authCode: String?
...
<RustDoc>
Now let's create main program file. Create a file named `src/main.rs` in the 
project directory.
</RustDoc>
<NodeJSDoc>
