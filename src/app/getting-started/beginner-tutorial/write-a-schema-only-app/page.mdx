...
```
```txt
teo Teo 0.2.4 (Python 3.12.2) [CLI]
```
</CodeResult>
</PythonDoc>
...
understanding Teo schema, take it easy, join our [Discord group](https://teocloud.io/discord), there 
...
[2023-12-20 04:58:40] Teo 0.2.4 (Rust 1.76.0, CLI)
...
```txt
[2023-12-20 04:58:40] sqlite connector connected for `main` at "sqlite::memory:"
[2023-12-20 04:58:40] Teo 0.2.4 (Python 3.12.2, CLI)
[2023-12-20 04:58:40] listening on port 5050
```
</CodeResult>
</PythonDoc>
...
Find us in [our Discord group](https://teocloud.io/discord) if you have any troubles.
