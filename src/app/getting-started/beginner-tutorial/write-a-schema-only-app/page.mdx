...
highly recommend you to init a Node.js project and install Teo locally. This
...
```
```txt
teo Teo 0.3.1 (Node.js v23.3.0) [CLI]
```
</CodeResult>
...
If you see some outputs like `Python 3.13.0`, great! Python is installed 
successfully.

Although now you can install Teo globally with the `pip` package manager. We
highly recommend you to create a virtual environment and install Teo locally. 
...
```
```txt
teo Teo 0.3.1 (Python 3.13.0) [CLI]
```
</CodeResult>
</PythonDoc>
...
We highly recommend you to use [VSCode](https://code.visualstudio.com) as we created 
...
connector {
  provider: .postgres,
  url: "postgres://localhost:5432/helloschemaonly",
}
...
connector {
  provider: .mongo,
  url: "mongodb://localhost:27017/helloschemaonly",
}
...
<SQLiteDoc>complete. Obviously, this server app connects to an in-memory SQLite database.</SQLiteDoc>
<MySQLDoc>complete. Obviously, this server app connects to a MySQL database.</MySQLDoc>
<PostgreSQLDoc>complete. Obviously, this server app connects to a PostgresSQL database.</PostgreSQLDoc>
<MongoDBDoc>complete. Obviously, this server app connects to a MongoDB database.</MongoDBDoc>
...
language is inspired by a lot of languages like TypeScript, Swift, GraphQL and Prisma.
...
[2023-12-20 04:58:40] Teo 0.3.1 (Rust1.82, CLI)
...
```txt
[2023-12-20 04:58:40] sqlite connector connected for `main` at "sqlite::memory:"
[2023-12-20 04:58:40] Teo 0.3.1 (Node.js v23.3.0, CLI)
[2023-12-20 04:58:40] listening on port 5050
```
</CodeResult>
</NodeJSDoc>
...
```txt
[2023-12-20 04:58:40] sqlite connector connected for `main` at "sqlite::memory:"
[2023-12-20 04:58:40] Teo 0.3.1 (Python 3.13.0, CLI)
[2023-12-20 04:58:40] listening on port 5050
```
</CodeResult>
</PythonDoc>

If you see the output like above, congratulation, it starts successfully.
