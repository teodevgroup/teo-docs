...
```
```txt
teo Teo 0.3.1 (Node.js v21.6.2) [CLI]
```
</CodeResult>
...
[2023-12-20 04:58:40] Teo 0.3.1 (Rust1.77.1, CLI)
...
```txt
[2023-12-20 04:58:40] sqlite connector connected for `main` at "sqlite::memory:"
[2023-12-20 04:58:40] Teo 0.3.1 (Node.js v21.6.2, CLI)
[2023-12-20 04:58:40] listening on port 5050
```
</CodeResult>
</NodeJSDoc>
