...
```
```txt
teo Teo 0.3.2 (Node.js v23.3.0) [CLI]
```
</CodeResult>
...
```
```txt
teo Teo 0.3.2 (Python 3.13.0) [CLI]
```
</CodeResult>
</PythonDoc>
...
```txt
[2023-12-20 04:58:40] sqlite connector connected for `main` at "sqlite::memory:"
[2023-12-20 04:58:40] Teo 0.3.2 (Node.js v23.3.0, CLI)
[2023-12-20 04:58:40] listening on port 5050
```
</CodeResult>
</NodeJSDoc>
...
```txt
[2023-12-20 04:58:40] sqlite connector connected for `main` at "sqlite::memory:"
[2023-12-20 04:58:40] Teo 0.3.2 (Python 3.13.0, CLI)
[2023-12-20 04:58:40] listening on port 5050
```
</CodeResult>
</PythonDoc>
