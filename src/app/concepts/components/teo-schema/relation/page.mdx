...
[**property**](/docs/concepts/components/teo-server/property). Like field and
relation, it can be used as input or output. Property is not primitive fields,
they are calculated.

<PrevNext>
  <PrevArticle href="/docs/concepts/components/teo-schema/field">Field</PrevArticle>
  <NextArticle href="/docs/concepts/components/teo-schema/property">Property</NextArticle>
</PrevNext>
