...
documented `@name`. It can have any number of [indexes](/concepts/components/teo-schema/index) <span className="concept">CONCEPT</span>.
...
<span className="concept">CONCEPT</span> topic.
...
[**model field**](/concepts/components/teo-schema/model-field), which 
