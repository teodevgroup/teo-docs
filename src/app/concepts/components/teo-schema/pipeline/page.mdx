...
[Pipeline](//docs/reference/api-reference/teo-schema-reference#pipeline)
...
In the next article, [**identity**](/docs/concepts/components/teo-schema/identity)
is introduced. Teo allows users of different models to sign in.

<PrevNext>
  <PrevArticle href="/docs/concepts/components/teo-schema/action">Action</PrevArticle>
  <NextArticle href="/docs/concepts/components/teo-schema/identity">Identty</NextArticle>
</PrevNext>
