...
[**action**](/concepts/components/teo-server/action), which represents
HTTP endpoints.

<PrevNext>
  <PrevArticle href="/concepts/components/teo-schema/property">Property</PrevArticle>
  <NextArticle href="/concepts/components/teo-schema/action">Action</NextArticle>
</PrevNext>
