...
[**action**](/docs/concepts/components/teo-server/action), which represents
HTTP endpoints.

<PrevNext>
  <PrevArticle href="/docs/concepts/components/teo-schema/property">Property</PrevArticle>
  <NextArticle href="/docs/concepts/components/teo-schema/action">Action</NextArticle>
</PrevNext>
