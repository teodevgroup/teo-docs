...
Defines a [connector](/docs/concepts/components/teo-server/connector)
...
Defines a [server](/docs/concepts/components/teo-server/server)
<span class="concept">CONCEPT</span> in the Teo schema. This config block is
required.
...
Defines an [entity generator](/docs/concepts/)
<span class="concept">CONCEPT</span> in the Teo schema. This config block is
optional.
...
Defines an [client generator](/docs/concepts/)
<span class="concept">CONCEPT</span> in the Teo schema. This config block is
optional.
...
Defines a Teo [model](/docs/concepts/components/teo-server/model)
...
Defines a [virtual model](/docs/concepts/components/teo-server/model#virtual-model)
<span class="concept">CONCEPT</span>.
...
Defines an [identity model](/docs/concepts/components/teo-server/model#identity-model)
<span class="concept">CONCEPT</span>.
...
[Fields](/docs/concepts/components/teo-server/field)
...
[fields](/docs/concepts/components/teo-server/field) <span class="concept">CONCEPT</span>,
[relations](/docs/concepts/components/teo-server/relation) <span class="concept">CONCEPT</span>, and
[properties](/docs/concepts/components/teo-server/property) <span class="concept">CONCEPT</span> in nature.
...
Defines an [enum](/docs/concepts/components/teo-server/enum)
<span class="concept">CONCEPT</span>.
